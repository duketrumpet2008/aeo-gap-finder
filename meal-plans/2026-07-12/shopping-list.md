# Shopping List — Week of Sun Jul 12, 2026
...
- [ ] Broccoli — **1 head** (Tuesday dinner side)
- [ ] Butter/Boston lettuce — **1 head**, soft leaves (spring rolls)
...
- [ ] Fresh mint — **1 bunch** (spring rolls)
- [ ] Fresh cilantro — **1 bunch** (tacos, 1 cup chopped)
...
- [ ] Sour cream — **1 small container** (taco fixings)
- [ ] Eggs — **1 dozen** (2 extra-large for cutlet breading + fried eggs for pad kra pao)

## Bakery
- [ ] Crusty sourdough or ciabatta loaf — **1** (3–4 cups cubed for panzanella)
- [ ] Corn tortillas, small — **1 pack (10–12)** (recipe calls for 30 to serve 6–10; a dozen covers 2 with leftovers)

## Pantry & dry goods
- [ ] Chickpeas — **1 can (15 oz)** (hummus)
...
- [ ] Chiles de árbol — **6** — or skip and use 1 tbsp red pepper flakes (taco marinade)
- [ ] Powdered fruit pectin — **1 box (1.75 oz, e.g. Sure-Jell original)** (jam)
...
- [ ] Olive oil (extra-virgin) — used everywhere; vinaigrettes take ~1 cup total
- [ ] Neutral oil (vegetable/canola) — pad kra pao, tacos, frying eggs
- [ ] Kosher salt — **the brine alone takes 2 tbsp**; check the box isn't nearly empty
- [ ] Black pepper
...
- [ ] Butcher's twine (trussing the roast chicken)
- [ ] Gallon zip-top bags (buttermilk brine + taco marinade)
- [ ] Crushed peanuts (peanut sauce garnish — optional)
